"""
Django settings for stockpredictionai project.
...
SECRET_KEY = 'django-insecure-t8njq3z*wg9g)h1m0^mjj==@kn79p$l@b-fvt_nwnw#*1907k('
...
STATICFILES_DIRS = [
    BASE_DIR / "static",  # Replace BASE_DIR with your project's base directory if needed
]
...
ROOT_URLCONF = 'stockpredictionai.urls'
...
WSGI_APPLICATION = 'stockpredictionai.wsgi.application'
